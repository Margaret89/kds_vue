<template>
	...
	<div class="popup-wrap">
		<div class="popup-check">
			...
			<div class="popup-check__title">New version found!</div>
			<div class="popup-check__text">Please update now to get more abilities from atmos and improve your exprience. </div>

			<div class="popup-check__version">
				<my-button class="btn_grey">
					<svg class="icon ic-download" width="30" height="30">
						<use xlink:href="@/assets/sprites/sprite.svg#ic-download"></use>
					</svg>
					Version 1.34.4
				</my-button>
			...
			<div class="popup-check__btn">
				<my-button class="btn_green">Update now</my-button>
			</div>

			<div class="popup-check__note">Maybe later</div>
		</div>
	</div>
</template>
