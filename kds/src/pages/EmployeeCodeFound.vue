	...
	<div class="popup-wrap">
		<div class="popup-identif-code">
			<div class="popup-identif-code__content">
				...
				<div class="popup-identif-code__title">
					Hello Osher<img src="@/assets/img/winking-face.png" alt="">
				</div>

				<div class="popup-identif-code__text">Please type your employee number</div>
